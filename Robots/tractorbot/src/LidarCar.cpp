 ...
 * - 车方向及其速度控制
 * A range 0/1 lateral movement sign, when it is 1, the car can move laterally to the left and right,
...
{  
  ...
  Serial.print("WheelPowers:");
  Serial.print(wheelPowerA);
  Serial.print(",");
  Serial.print(wheelPowerB);
  Serial.print(",");
  Serial.print(wheelPowerC);
  Serial.print(",");
  Serial.println(wheelPowerD);

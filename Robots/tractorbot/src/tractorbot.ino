...
constexpr char WIFI_PASS[] = "secret";
...
void initServer()
{
  ...
  server.on("/properties/motorcurrent", HTTP_GET, [](AsyncWebServerRequest *request){ request->send(200, "application/json", String(current)); });
